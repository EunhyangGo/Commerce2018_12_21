...
import com.biz.commerce.service.CommerceService2;
...
public class Exec03 {
	public static void main(String[] args) {
		...
		String inforFile 
		="src/com/biz/commerce/상품리스트1.txt";
		/*
		 ...
		 * 매개변수로 전달하는 것과 같다.
		 */
		CommerceService2 is = new CommerceService2(ioFile,pFile);
